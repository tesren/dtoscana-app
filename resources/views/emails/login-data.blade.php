...
<html lang="es">
    ...
    <head>
        ...
        <title>Mensaje de D'Toscana Nuevo Vallarta</title>
    </head>
    ...
    <body>
        ...
        @if($lang == 'es')
            ...
            <p>
                En Domus nos enorgullece informarle que ha llegado el momento de iniciar la preventa privada de “D'TOSCANA”, que es exclusiva para las personas que, así como usted, solicitaron ser incluidos en este exclusivo evento.
                
            </p> 

            <p>
                A partir de este momento, usted podrá ingresar al sitio especial D'TOSCANA {{ url('/login') }}, en donde podrá encontrar información detallada del proyecto, así como de las unidades disponibles, de manera que usted pueda seleccionar y comprar el condominio de su preferencia, usando la siguiente información:
        ...
        @else
            ...
            <p>In Domus we are proud to inform you that the time has come to start the private presale of "D'TOSCANA," which is exclusive for people who, like you, requested to be included in this exclusive event.</p>
            
            <p>From this moment on, you will be able to enter the special site D'TOSCANA {{ url('/login') }}, where you will be able to find detailed information about the project, as well as the available units, so that you can select and purchase the condominium of your preference, using the following information:</p>
            ...
            <p>You will already have time to analyze the information in detail, but we can tell you in advance that D'TOSCANA has a very good variety of different types of units, with different price ranges for all tastes and needs, with views of the ocean, the golf course, and the common areas of the development.</p>
